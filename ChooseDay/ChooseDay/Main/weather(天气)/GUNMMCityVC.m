...
- (void)receiveTextValueChange{
    ...
    if (_textField) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(textAct:) name:UITextFieldTextDidChangeNotification object:nil];
    }
    

}

-(void)textAct:(NSNotification *)notification
{
